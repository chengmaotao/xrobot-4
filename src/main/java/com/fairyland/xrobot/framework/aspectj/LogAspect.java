package com.fairyland.xrobot.framework.aspectj;

import com.alibaba.fastjson.JSON;
import com.fairyland.xrobot.common.enums.HttpMethod;
...
import com.fairyland.xrobot.framework.aspectj.lang.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.fairyland.xrobot.framework.aspectj.lang.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            operLog.setJsonResult(JSON.toJSONString(jsonResult));// 返回参数
