 ...
 * <p>
 * new String(encoded); // is "73XpUgyMwkGr29M" Decoding
 * <p>
...
public class Base62 {
    ...
    /**
     * Creates a {@link Base62} instance. Defaults to the GMP-style character
     * set.
     *
    ...
    /**
     * Uses the elements of a byte array as indices to a dictionary and returns
     * the corresponding values in form of a byte array.
     */
    ...
    /**
     * Converts a byte array from a source base to a target base using the
     * alphabet.
     */
    private byte[] convert(final byte[] message, final int sourceBase, final int targetBase) {
        ...
        // pad output with zeroes corresponding to the number of leading zeroes
        // in the message
    ...
    /**
     * Creates the lookup table from character to index of character in
     * character set.
     */
