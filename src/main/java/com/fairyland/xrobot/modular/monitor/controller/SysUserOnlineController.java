...
import com.fairyland.xrobot.modular.monitor.domain.SysUserOnline;
import com.fairyland.xrobot.modular.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController {
    ...
    public TableDataInfo list(String ipaddr, String userName) {
        Collection<String> keys = redisCache.keys(Constants.LOGIN_MOUNTTAI_TOKEN_KEY + "*");
        List<SysUserOnline> userOnlineList = new ArrayList<SysUserOnline>();
        for (String key : keys) {
            LoginUser user = redisCache.getTokenCacheLoginUser(key);
